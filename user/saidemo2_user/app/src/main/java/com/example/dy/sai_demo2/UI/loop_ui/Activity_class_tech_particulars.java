...
public class Activity_class_tech_particulars extends AppCompatActivity {
    TextView title_tx;
    TextView content_tx;
    TextView date_tx;
    TextView author_tx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_tech_particulars);
        initview();
        ...
        final StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    object = object.optJSONObject("user");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_class_tech_particulars.this,"error", Toast.LENGTH_SHORT).show();
            }
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                mHeaders.put("Cookie","user_id="+ Storage.getString(Activity_class_tech_particulars.this,KEY_USER_ID));
                Log.d("send_head_cookie","user_id="+ Storage.getString(Activity_class_tech_particulars.this,KEY_USER_ID));
