...
import com.example.dy.sai_demo2.UI.primain_ui.Fragment_game;

import com.example.dy.sai_demo2.UI.primain_ui.Fragment_recruite;
...
public class Fragment_primain extends Fragment {
    ...
    private void initview(){
        ...
        fragmentList.add(new Fragment_recruite());
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    tx_student_id.setText(object.optString("business_scope"));
