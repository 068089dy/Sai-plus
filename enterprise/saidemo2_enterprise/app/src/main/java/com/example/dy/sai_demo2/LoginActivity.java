...
import static com.example.dy.sai_demo2.Common.Const.LINK_login;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void initview(){
        ...
        try{
            edit_password.setText(getIntent().getStringExtra("password"));
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://"+SERVER_IP+LINK_login;
