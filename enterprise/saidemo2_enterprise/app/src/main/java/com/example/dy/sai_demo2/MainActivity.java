...
public class MainActivity extends AppCompatActivity {
    ...
    private void initdata(){
        drawerList.clear();
        Drawer dra_cld = new Drawer("查看招募站",R.drawable.drawer_cld);
        ...
        drawerList.add(new Drawer("已发布比赛",R.drawable.drawer_mymatch));
    ...
    private void get_user_data() {
        ...
        String url = "http://123.206.69.183/enterprise_load";
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    tx_stu_num.setText(object.optString("business_scope"));
                    tx_username.setText(object.optString("name"));
                    tx_school.setText(object.optString("describe"));
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                mHeaders.put("Cookie", "enterprise_id=" + Storage.getString(MainActivity.this, KEY_USER_ID));
                return mHeaders;
            }
        };
        queue.add(request);
