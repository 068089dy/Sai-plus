...
//                    }
                    ...
                    if(!object.optString("enterprise").equals("null")){
                        object = object.optJSONObject("enterprise");
                        enterprise_name_tx.setText(object.optString("name"));
                    }
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                mHeaders.put("Cookie","enterprise_id="+intent.getStringExtra("user_id"));
