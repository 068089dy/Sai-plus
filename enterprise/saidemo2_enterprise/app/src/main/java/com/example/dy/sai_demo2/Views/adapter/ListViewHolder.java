...
public class ListViewHolder {
    ...
    public synchronized static ListViewHolder getHolder(Context context,int layoutId, View convertView, ViewGroup parent){
        if (null==convertView){
            return new ListViewHolder(context,layoutId,parent);
        }else{
     ...
     * @return
     */
    public ListViewHolder setStr(int viewId,String content){
    ...
    public ListViewHolder setInt(int viewId,int content){
        View view=getView(viewId);
        if (view instanceof ImageView){
            ((ImageView) view).setImageResource(content);
        }
        return this;
    }
